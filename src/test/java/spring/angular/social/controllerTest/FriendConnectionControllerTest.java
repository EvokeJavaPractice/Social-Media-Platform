...
public class FriendConnectionControllerTest {
    ...
    public void testCreateFriendConnection_Success() {
        ...
        Mockito.when(friendConnectionService.createFriendConnection(user, friend)).thenReturn(connection);
    ...
    public void testDeleteFriendConnection_Success() {
        ...
        ResponseEntity<?> response = friendConnectionController.deleteFriendConnection(id);
